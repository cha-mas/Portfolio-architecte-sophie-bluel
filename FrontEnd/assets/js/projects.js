...
function createAllButton() {
    ...
    button.dataset.categoryId = CATEGORY_IDS.ALL;
...
function createCategoryButtonsContainer(categories) {
    ...
    if (!projectsElement) return null;
    ...
    buttons.forEach(function(button) {
        button.addEventListener('click', function() {
            buttons.forEach(function(b) {
                b.classList.remove(CSS_CLASSES.SELECTED_CATEGORY);
            });
            button.classList.add(CSS_CLASSES.SELECTED_CATEGORY);
...
function createEditButton() {
    ...
    btn.innerHTML = `
        ...
        <p style="font: 'inherit'">modifier</p>
    `;
